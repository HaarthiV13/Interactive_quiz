...
if __name__=="__main__":
    ...
    q1= QuestionMC()
    q1.text="=> Which is the correct way to comment multiple lines in Python?"
    q1.points=5
    q1.correct_answer="b"
    ans=Answer()
    ans.name="a"
    ...
    q2 = QuestionTF()
    q2.text= "=> Python's range() function returns a list?"
    q2.points=2
    q2.correct_answer="f"
    qz.questions.append(q2)

    q3= QuestionMC()
    q3.text="=> How do you define a function in Python?"
    q3.points=5
    q3.correct_answer="c"
    ans=Answer()
    ans.name="a"
    ans.text="function myFunction()"
    q3.answers.append(ans)
    ans=Answer()
    ans.name="b"
    ans.text=" create myFunction()"
    q3.answers.append(ans)
    ans=Answer()
    ans.name="c"
    ans.text="def myFunction(): "
    q3.answers.append(ans)
    ans=Answer()
    ans.name="d"
    ans.text="func myFunction():"
    q3.answers.append(ans)
    qz.questions.append(q3)

    q4 = QuestionTF()
    q4.text= " => The += operator in Python can be used to concatenate strings?"
    q4.points=3
    q4.correct_answer="t"
